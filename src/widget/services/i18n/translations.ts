...
export const translations: WidgetTranslations = {
  lt: {
    ...
    profile: {
      ...
      customerIdHelp: "Jūsų kliento ID padeda mums teikti personalizuotas rekomendacijas",
    ...
    chat: {
      ...
      placeholderGeneral: "Kalbėkitės apie bet ką arba prašykite produktų rekomendacijų...",
      send: "Siųsti",
      thinking: "Galvoju...",
      errorMessage: "Atsiprašome, įvyko klaida. Leiskite man vis tiek pabandyti jums padėti. Kokių produktų ieškote?",
    ...
    modal: {
      ...
      customerIdDescription: "Norėdami gauti personalizuotas rekomendacijas, įveskite savo kliento ID. Jei neturite, galite praleisti šį žingsnį.",
  ...
  en: {
    ...
    profile: {
      ...
      customerIdHelp: "Your Customer ID helps us provide personalized recommendations",
    ...
    chat: {
      ...
      placeholderGeneral: "Chat about anything or ask for product recommendations...",
      send: "Send",
      thinking: "Thinking...",
      errorMessage: "I apologize, but I encountered an issue. Let me try to help you anyway. What kind of products are you interested in?",
    ...
    modal: {
      ...
      customerIdDescription: "To get personalized recommendations, please enter your Customer ID. If you don't have one, you can skip this step.",
